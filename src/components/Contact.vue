...
<template>
    <div class="max-w-4xl mx-auto py-8 px-4" data-aos="fade-up">
      <div class="flex flex-col md:flex-row items-center">
        <!-- Vertical Tabs (bigger font) -->
        <div class="tabs tabs-vertical tabs-boxed flex-shrink-0 mb-6">
        <a
          ...
          :class="[
            ...
            'min-w-[8rem]',/* ensure a comfortable width */
        ...
        <div class="flex-1 md:pl-8 space-y-4 text-lg text-center">
          <p>
            <i class="fas fa-envelope"></i>
            Email:
            <a :href="`mailto:${current.email}`" class="text-primary underline">
              {{ current.email }}
            </a>
          </p>
          <p>
          ...
          <p>
            ...
            Endereço: {{ current.address }}
          </p>
          <p v-if="current.website">
          ...
          <!-- Map Embed -->
          <div class="mt-6 h-64 w-full rounded-lg overflow-hidden shadow-lg">
            <iframe
  ...
  const current = computed(() => extensions[selectedIndex.value])
  </script>
  
  <style scoped>
  /* no extra CSS needed—DaisyUI and Tailwind handle the centering */
  </style>
