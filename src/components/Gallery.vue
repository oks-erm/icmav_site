...
<template>
  ...
  const images = [
    ...
    `${pathBase}photos/gallery/20250323_0124.jpg`,
    `${pathBase}photos/gallery/RVAZ8386.jpg`,
    `${pathBase}photos/gallery/RVAZ8339.jpg`,
    `${pathBase}photos/gallery/20250615_0043.jpg`,
    `${pathBase}photos/gallery/20250518_0031.jpg`,
    `${pathBase}photos/gallery/20250202_0230.jpg`,
